...
export default function AddPortfolioPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        Kananame: faculties[3],
        Sakaname: "",
        university: "",
        portfolioLink: "",
        description: "",   // ← field ใหม่
    })
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const payload = { ...formData, coverprom: base64Image };
    ...
    return (
        <div className="add-portfolio-container" style={{
            maxWidth: "600px", margin: "2rem auto", padding: "2rem",
            border: "1px solid #ddd", borderRadius: "10px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)"
        }}>
            <button onClick={() => navigate("/")} style={{ marginBottom: "1rem", background: "none", border: "none", color: "#007bff", cursor: "pointer" }}>
                ← กลับหน้าหลัก
            </button>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    ...
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        type="text" value={formData.fullName}
                        onChange={(e) => setFormData({ ...formData, fullName: e.target.value })}
                        placeholder="เช่น นายกุดข้าวปุ้น รักเรียน" required />
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    ...
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        ...
                        placeholder="เช่น นนท์" required />
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    <label>ปีที่จบการศึกษา (พ.ศ.) *</label>
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        type="number" min="2500" max="2600" value={formData.graduationYear}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    ...
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        type="text" value={formData.Sakaname}
                        onChange={(e) => setFormData({ ...formData, Sakaname: e.target.value })}
                        placeholder="เช่น วิศวกรรมคอมพิวเตอร์" required />
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    ...
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        ...
                        placeholder="เช่น มหาวิทยาลัยขอนแก่น" required />
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    ...
                    <input style={{ padding: "8px", borderRadius: "5px", border: "1px solid #ccc" }}
                        ...
                        placeholder="https://www.canva.com/..." required />
                </div>

                {/* ── คำอธิบาย (field ใหม่) ── */}
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    <label>คำอธิบาย / ฝากถึงรุ่นน้อง</label>
                    <textarea
                        style={{
                            padding: "8px", borderRadius: "5px", border: "1px solid #ccc",
                            minHeight: "120px", resize: "vertical", fontFamily: "inherit", fontSize: "14px"
                        }}
                        value={formData.description}
                        onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                        placeholder="เล่าถึง Portfolio ของคุณ เทคนิคการเตรียมตัว หรือข้อแนะนำสำหรับรุ่นน้อง..."
                    />
                    <small style={{ color: "#666" }}>จะแสดงในหน้าต่าง popup เมื่อผู้เข้าชมคลิกดูรายละเอียด</small>
                </div>
